<template>
  <fvMain>
    ...
    <fvContent>
      <fvHeader>
        <fvButton
          class="fv-margin-end fv-hidden-lg fv-hidden-xl"
          @click="toggleSidebar"
        >
        ...
        <div class="fv-grow">
          ...
          <small class="fv-hidden-sm fv-hidden-xs">
            Generated Nuxt + Framevuerk Template
          </small>
        </div>
          ...
          <fvMenu v-model="docsMenu">
            <div>
              <div class="fv-border-bottom fv-padding">
                <label class="fv-text-light">
                  <i class="material-icons">list</i> Documents
                </label>
              </div>
              <div class="fv-padding">
                <a
                  class="fv-link fv-block fv-margin-bottom"
                  target="_blank"
                  href="https://www.framevuerk.com/"
                  ><i class="material-icons">link</i> Framevuerk Docs</a
                >
                <a
                  class="fv-link fv-block fv-margin-bottom"
                  target="_blank"
                  href="https://github.com/framevuerk/framevuerk"
                  ><i class="material-icons">link</i> Framevuerk on Github</a
                >
                <a
                  class="fv-link fv-block fv-margin-bottom"
                  target="_blank"
                  href="https://nuxtjs.org/"
                  ><i class="material-icons">link</i> Nuxt Docs</a
                >
                <a
                  class="fv-link fv-block"
                  target="_blank"
                  href="https://github.com/nuxt/nuxt.js"
                  ><i class="material-icons">link</i> Nuxt on GitHub</a
                >
              </div>
            </div>
          </fvMenu>
      ...
      <div class="content fv-padding">
        ...
        <div class="content__header fv-margin-bottom fv-padding">
          ...
          <p>
            <b>Framevuerk</b> is a Fast, Responsive, Without Dependencies, Both
            Direction Support and Configurable UI Framework based on
            <b>Vue.js</b>. In this template we just add it to <b>Nuxt.js</b> and
            put some of most usable component inside a form to show you how it's
            look like.
          </p>
        </div>
        <div class="content__body fv-border fv-radius fv-shadow">
          <label class="fv-control-label fv-padding">
          ...
          <div class="fv-padding container">
            <fvForm class="fv-row">
              ...
              <fvFormElement class="fv-col-sm-4" label="Is Maried?" inline>
                <fvSwitch
                  v-model="exmps.married"
                  @input="exmps.marriageDate = undefined"
                />
              </fvFormElement>
              <fvFormElement class="fv-col-sm-8" label="Date of Marriage">
                <fvDatepicker
                  v-model="exmps.marriageDate"
                  placeholder="Enter Date of Marriage"
                  :disabled="!exmps.married"
                />
              </fvFormElement>
